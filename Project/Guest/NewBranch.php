...
if(isset($_POST['btn_submit']))
{
	...
	$insqry="insert into tbl_branch(branch_name,branch_contact,branch_email,place_id,branch_address,branch_password,branch_photo)values('$name','$contact','$email','$place','$address','$password','$image')";
	echo $insqry;
	if($con->query($insqry))
	{
		?>
...
<title>LuanTech::Guest:::NewBranch</title>
</head>
